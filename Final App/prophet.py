...
These are the functions used to implement the Facebook Deep Learning
Time Series Model to forecast the time series data.
Prophet is fitted to the data and temperatures that is outside the
prediction range are labelled anomalies.
"""
