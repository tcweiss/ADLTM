                    ...
                    [
                        ...
                        dbc.CardBody(
                            [
                                ...
                                html.P([
                                    "Marc's main responsibility was turning the Machine Learning models into a comprehensive software solution. He developed the backend, including the database queries and data manipulations, and improved the overall efficiency. Furthermore, he defined and implemented various features in the app, such as the heatmap functionality. He also designed and created the frontend of the app. Please contact Marc regarding questions about the backend, frontend, and the app's features: ",
                                    html.A('email',
...
# Update graph every 10 seconds for most current data
...
def update_heatmap_automatically(n):
    data = es_get_current_diff()
    heatmap_abs = create_plotly_ff_heatmap_abs2(data)
    heatmap_diff = create_plotly_ff_heatmap_diff(data)
